        ...
        <q-dialog v-model="fixed">
            <q-card class="modal-content">
                ...
                <q-card-section style="max-height: 50vh" class="scroll">
                    <q-input v-model="cedula" label="cedula" style="width: 300px;" v-if="cambio == 0" />
            ...
            <q-table title="Clientes" :rows="rows" :columns="columns" row-key="name">
                ...
                <template v-slot:body-cell-opciones="props">
                    <q-td :props="props" class="botones">
                        <q-btn color="blue-4" style="margin-right: 5px;" text-color="black" @click="EditarCliente(props.row._id)"><q-icon name ="edit"/></q-btn> 
                        <q-btn color="green-4" glossy  @click="InactivarCliente(props.row._id)"
