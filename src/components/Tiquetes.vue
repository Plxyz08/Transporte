...
const agregarCliente = () => {
  // Show the modal for adding a new client
  fixed.value = true;
};
...
const guardarVenta = () => {
  ...
  // Si se cumplen ambas validaciones, puedes cerrar el modal
...
const buscarCliente = () => {
  // Implementa la lógica para buscar un cliente por Cédula
  // Actualiza las variables clienteEncontrado y clienteNoEncontrado
};
